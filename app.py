...
path = Path('Cars_Dataset\CarBrandClassifierTeam05.pkl')

learn = load_learner(path)

df = pd.read_csv("Cars_Dataset\Train\labels.csv",index_col=['Index'])

def get_name(cat_num):
    return df[df.index == cat_num].reset_index(drop=True)['Car_Model'][0]
...
html_temp = """
    ...
    <p style="color:white;text-align:center;" >This is a <b>Streamlit</b> app use for prediction of the <b>102 types of Car</b>.</p>
    </div>
    """
